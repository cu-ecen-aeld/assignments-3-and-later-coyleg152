...
cp -a ${SYSROOT}/lib/ld-linux-aarch64.so.1 ${OUTDIR}/rootfs/lib/ld-linux-aarch64.so.1
cp -a ${SYSROOT}/lib64/libm.so.6 ${OUTDIR}/rootfs/lib64/lib64.so.6
...
cp conf/username.txt ${OUTDIR}/rootfs/home/username.txt
cp conf/assignment.txt ${OUTDIR}/rootfs/home/assignment.txt
